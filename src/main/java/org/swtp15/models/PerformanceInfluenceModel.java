...
public class PerformanceInfluenceModel {
    ...
    /**
     * Evaluates the property values for a list of active features.
     * Iterates over the featureInfluences and adds their value if their set of activeFeatures
     * is contained in the given set of activeFeatures.
